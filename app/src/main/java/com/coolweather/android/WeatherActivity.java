...
public class WeatherActivity extends AppCompatActivity {
    ...
    private ScrollView weatherLayout;//加载布局
    ...
    private LinearLayout forecastLayout;//天气预测的布局
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bingPicImg=(ImageView) findViewById(R.id.bing_pid_img);
        ...
        if (weatherString!=null){
            ...
            //无缓存时去服务器查询天气
            mWeatherId=getIntent().getStringExtra("weather_id");//获得键为 weather_id 的值
        ...
        String bingPic=prefs.getString("bing_pic",null);//取出键为 bing_pic 的值
        if (bingPic!=null){
    ...
    * */
    public void requestWeather(final String weatherId){
        String weatherUrl="http://guolin.tech/api/weather?cityid="+weatherId+"&key=\t\n" +
                "e21ef87d93584cb792e18ec32ab1eb88";
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        if (weather!=null && "ok".equals(weather.status)){
                            ...
                            editor.putString("weather",responseText);//将键为weather的值为responseText
                            editor.apply();//将修改的数据提交到内存
                            mWeatherId=weather.basic.weatherId;
                            showWeatherInfo(weather);
                        }else {
                            Toast.makeText(WeatherActivity.this,"获取天气信息失败",Toast.LENGTH_SHORT).show();
    ...
    private void loadBingPic(){
        ...
        HttpUtil.sendOkHttpRequest(requestBingPic, new Callback() {
            ...
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                ...
                SharedPreferences.Editor editor=PreferenceManager.getDefaultSharedPreferences(WeatherActivity.this).edit();
                editor.putString("bing_pic",bingPic);//将键为bing_pic的值为bingPic
                editor.apply();//将修改的数据提交到内存
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
    ...
    * */
    private void showWeatherInfo(Weather weather){
        ...
        for (Forecast forecast:weather.forecastList) {
            ...
            forecastLayout.addView(view);//再添加
        }
        if (weather.aqi!=null){
